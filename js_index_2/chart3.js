...
var array_distance_thamchieu_chart3 = new Array();
var array_thamchieu_chart3 = new Array();
...
docClient.query(params_chart3, function(err, data) {
    ...
    for (let i = 0; i < array_distance_chart3.length; i++) {
        thamchieu_data = array_distance_chart3[i] - avg_thamchieu_final;
        thamchieu_data_final = Math.round(thamchieu_data * 1000) / 1000; // Làm tròn
        array_distance_thamchieu_chart3.push(thamchieu_data_final)
    }
    for (let i = 0; i < data.Items.length; i++) {
    ...
    const y_data_chart3 = array_distance_thamchieu_chart3;
