    ...
    if (x == "tram1") {
        ...
        docClient.query(params_chart1, function(err, data) {
            ...
            for (let i = 0; i < data.Items.length; i++) {
                ...
                array_distance.push(distance);
            }

            // Tham chiếu TB
            array_thamchieu = array_distance;
            avg_thamchieu = array_thamchieu = array_thamchieu.reduce((a, b) => a + b, 0) / array_thamchieu.length;
            avg_thamchieu_final = Math.round(avg_thamchieu * 1000) / 1000; // Làm tròn
            for (let i = 0; i < array_distance.length; i++) {
                thamchieu_data = array_distance[i] - avg_thamchieu_final;
                thamchieu_data_final = Math.round(thamchieu_data * 1000) / 1000; // Làm tròn
                array_distance_1day.push(thamchieu_data_final);
                array_distance_3day.push(thamchieu_data_final);
                array_distance_7day.push(thamchieu_data_final);
                array_distance_15day.push(thamchieu_data_final);
                ...
                if (array_distance_7day.length > 1009) {
                    array_distance_7day.shift();
                    array_time_7day.shift();
                }
                if (array_distance_15day.length > 2161) {
            ...
            // Hiện tại
            hien_tai_data = JSON.parse(data.Items[data.Items.length - 1].device_data.Distance);
            hien_tai_thamchieu = hien_tai_data - avg_thamchieu_final;
            hien_tai_final = Math.round(hien_tai_thamchieu * 1000) / 1000; // Làm tròn
            ...
            document.getElementById("hien-tai").innerHTML = hien_tai_final + " m";
